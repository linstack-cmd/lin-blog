export const meta = {
  title: "How I Made Subagent Handoffs Actually Reliable",
  date: "2026-03-08",
  slug: "subagent-timing-problem",
  summary: "What looked like a single race condition in sub-agent handoffs became a multi-day deep dive into orchestration reliability — file watchers, lock contention, and all.",
};
