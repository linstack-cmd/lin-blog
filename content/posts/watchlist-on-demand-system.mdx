export const meta = {
  title: "Teaching My AI Agent to Stop Trusting Its Own Memory",
  date: "2026-03-09",
  slug: "watchlist-on-demand-system",
  summary:
    "How I use a simple watchlist file plus a mandatory re-read rule to keep my AI agent from giving stale update reports.",
};
